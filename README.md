...
99 algorithms. 17 categories. 192 unique linked public demos. Sourced recommendations. Safe-usage guidance. Reference architectures. Post-quantum migration context.
...
|--------|----------------|
| **99 algorithms across 17 categories** | Coverage is broad enough to support real design tradeoffs, not just a curated shortlist |
...
|-----------|--------------------|
| **Browse by category** | 99 algorithms across elliptic curves, encryption, KEM, signatures, hashing, password hashing, ZKPs, MPC, OT/PIR, threshold signatures, and more |
