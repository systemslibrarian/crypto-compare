...
|--------|----------------|
| **100 algorithms across 17 categories** | Coverage is broad enough to support real design tradeoffs, not just a curated shortlist |
...
|-----------|--------------------|
| **Browse by category** | 100 algorithms across elliptic curves, encryption, KEM, signatures, hashing, password hashing, ZKPs, MPC, OT/PIR, threshold signatures, and more |
