...
export const ALGORITHM_PROVENANCE: Record<string, { sources: AlgorithmSource[]; lastReviewed: string }> = {
  ...
  chacha20_drbg: {
    ...
    sources: [
      ...
      { label: "Linux kernel random subsystem docs", url: "https://docs.kernel.org/admin-guide/hw_random.html", note: "Kernel random subsystem reference and RNG integration context.", kind: "deployment" },
    ],
  },
  fortuna: {
    lastReviewed: "2026-04-18",
