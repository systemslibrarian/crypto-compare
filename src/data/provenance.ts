...
// literature). On 2026-06-27 all 97 entries were re-verified in a single pass,
...
// flags the date once it is older than 180 days.
export const ALGORITHM_PROVENANCE: Record<string, { sources: AlgorithmSource[]; lastReviewed: string }> = {
  ...
  snow_v: {
    ...
    sources: [
      ...
      { label: "3GPP TS 35.216", url: "https://www.3gpp.org/specifications", note: "SNOW 3G specification (SNOW family). SNOW-V is a separate 256-bit candidate proposed for 5G, not yet 3GPP-mandated.", kind: "standard" },
    ],
  },
  aes256gcmsiv: {
    lastReviewed: "2026-06-27",
  ...
  bn254: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "Kim & Barbulescu 2016", url: "https://doi.org/10.1007/978-3-662-53018-4_20", note: "Extended Tower Number Field Sieve, CRYPTO 2016. Basis for the reduced (~100-bit) security estimate applied to BN254/alt_bn128.", kind: "analysis" },
    ],
  },
  brainpool_p256r1: {
    lastReviewed: "2026-06-27",
  ...
  smaug_t: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "KpqC selection (SMAUG-T)", url: "https://kpqc.cryptolab.co.kr/smaug-t", note: "SMAUG-T selected as a KpqC KEM winner (Jan 2025); security based on Module-LWE + Module-LWR with sparse secrets. Korean draft standard expected 2026.", kind: "analysis" },
    ],
  },
  hqc: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "NIST IR 8545 (HQC selection)", url: "https://csrc.nist.gov/pubs/ir/8545/final", note: "NIST selected HQC (March 2025) as its code-based KEM; draft FIPS expected 2026, final ~2027 (no FIPS number assigned yet).", kind: "standard" },
  ...
  classic_mceliece: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "NIST IR 8545 (4th round report)", url: "https://csrc.nist.gov/pubs/ir/8545/final", note: "NIST 4th round concluded (2025): Classic McEliece not selected; NIST pointed to the ISO/IEC 18033-2 standardization track instead.", kind: "standard" },
  ...
  frodokem: {
    ...
    sources: [
      ...
      { label: "ISO/IEC 18033-2 (Amd. 2)", url: "https://www.iso.org/standard/37971.html", note: "FrodoKEM being added to ISO/IEC 18033-2 (asymmetric ciphers) as Amendment 2.", kind: "standard" },
    ],
  },
  bike: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "NIST IR 8545 (4th round report)", url: "https://csrc.nist.gov/pubs/ir/8545/final", note: "NIST 4th round concluded (2025): BIKE not selected (NIST preferred HQC's more stable security analysis).", kind: "standard" },
      { label: "BIKE (NIST round-4 submission)", url: "https://csrc.nist.gov/projects/post-quantum-cryptography/round-4-submissions", note: "Official BIKE round-4 submission package (QC-MDPC code-based KEM). The bikesuite.org site had an expired TLS certificate at last review.", kind: "analysis" },
    ],
  },
  // ─── Signature ───────────────────────────────────────────────────
  mldsa44: {
  ...
  haetae: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "KpqC selection (HAETAE)", url: "https://kpqc.cryptolab.co.kr/", note: "HAETAE selected as a KpqC signature winner (Jan 2025); on the Korean Industrial Standard track.", kind: "analysis" },
    ],
  },
  falcon512: {
    lastReviewed: "2026-06-27",
  ...
  kupyna: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "Kupyna (DSTU 7564:2014)", url: "https://eprint.iacr.org/2015/956", note: "Oliynykov et al. — specification and analysis of the Kupyna hash function, the Ukrainian national standard DSTU 7564:2014.", kind: "analysis" },
    ],
  },
  // ─── KDF ─────────────────────────────────────────────────────────
  hkdf: {
  ...
  ckks: {
    ...
    sources: [
      ...
      { label: "Li & Micciancio 2021", url: "https://eprint.iacr.org/2020/1533", note: "IND-CPA-D key-recovery attack on approximate-number FHE (CKKS) when decryption results are shared; motivates noise-flooding mitigations.", kind: "analysis" },
    ],
  },
  ...
  ot_base: {
    ...
    sources: [
      ...
      { label: "Naor & Pinkas 2001", url: "https://dl.acm.org/doi/10.5555/365411.365502", note: "Efficient Oblivious Transfer Protocols, SODA 2001.", kind: "analysis" },
    ],
  },
  ot_extension: {
    lastReviewed: "2026-06-27",
  ...
  sm2_enc: {
    ...
    sources: [
      ...
      { label: "ISO/IEC 14888-3 Amd.1", url: "https://www.iso.org/standard/76382.html", note: "Registers the SM2 *signature* algorithm with ISO/IEC. The SM2 public-key encryption scheme here is standardized by GB/T 32918.4, not ISO/IEC 14888-3.", kind: "standard" },
    ],
  },
  // ─── Steganography ───────────────────────────────────────────────
  lsb_stego: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "Fridrich, Goljan & Du 2001", url: "https://dl.acm.org/doi/10.1145/1232454.1232466", note: "Reliable Detection of LSB Steganography in Color and Grayscale Images. ACM Workshop on Multimedia and Security 2001.", kind: "analysis" },
    ],
  },
  dct_f5: {
    lastReviewed: "2026-06-27",
  ...
  bpcs: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "Kawaguchi & Eason 1998", url: "https://doi.org/10.1117/12.337436", note: "Principles and Applications of BPCS-Steganography. SPIE Photonics East, Proc. 3528.", kind: "analysis" },
    ],
  },
  ...
  wow_stego: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "Holub & Fridrich 2012", url: "https://doi.org/10.1109/WIFS.2012.6412655", note: "Designing Steganographic Distortion Using Directional Filters. IEEE Workshop on Information Forensics and Security (WIFS).", kind: "analysis" },
    ],
  },
  ...
  chacha20_drbg: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "RFC 8439", url: "https://www.rfc-editor.org/rfc/rfc8439", note: "ChaCha20 and Poly1305 for IETF Protocols (obsoletes RFC 7539). Underlying cipher specification for ChaCha20-DRBG.", kind: "standard" },
      { label: "Linux random(7)", url: "https://man7.org/linux/man-pages/man7/random.7.html", note: "Linux CSPRNG overview; /dev/urandom output generation uses a ChaCha20-based construction.", kind: "deployment" },
    ],
  },
  fortuna: {
    lastReviewed: "2026-06-27",
