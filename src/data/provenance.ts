...
export const ALGORITHM_PROVENANCE: Record<string, { sources: AlgorithmSource[]; lastReviewed: string }> = {
  ...
  snow_v: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "ISO/IEC 18033-4", url: "https://www.iso.org/standard/54531.html", note: "International standard for stream ciphers including SNOW 2.0.", kind: "standard", supports: ["specification", "standardization"] },
      { label: "SNOW-V specification", url: "https://eprint.iacr.org/2018/1143", note: "Johansson & Yang, 2021. SNOW-V design for 5G.", kind: "analysis", supports: ["security"] },
      { label: "3GPP TS 35.216", url: "https://www.3gpp.org/specifications", note: "SNOW 3G specification (SNOW family). SNOW-V is a separate 256-bit candidate proposed for 5G, not yet 3GPP-mandated.", kind: "standard", supports: ["specification", "standardization"] },
    ],
  },
  aes256gcmsiv: {
    lastReviewed: "2026-06-27",
  ...
  bike: {
    lastReviewed: "2026-06-27",
    sources: [
      { label: "NIST IR 8545 (4th round report)", url: "https://csrc.nist.gov/pubs/ir/8545/final", note: "NIST 4th round concluded (2025): BIKE not selected (NIST preferred HQC's more stable security analysis).", kind: "standard", supports: ["specification", "standardization"] },
      { label: "BIKE (NIST round-4 submission)", url: "https://csrc.nist.gov/projects/post-quantum-cryptography/round-4-submissions", note: "Official BIKE round-4 submission package (QC-MDPC code-based KEM). The bikesuite.org site had an expired TLS certificate at last review.", kind: "analysis", supports: ["security"] },
    ],
  },
  // ─── Signature ───────────────────────────────────────────────────
  mldsa44: {
  ...
  lms_hss: {
    ...
    sources: [
      ...
      { label: "CNSA 2.0", url: "https://media.defense.gov/2022/Sep/07/2003071834/-1/-1/0/CSA_CNSA_2.0_ALGORITHMS_.PDF", note: "NSA CNSA 2.0 recommends LMS for firmware signing in the post-quantum transition.", kind: "standard", supports: ["specification", "standardization"] },
    ],
  },
  // ─── Hash ────────────────────────────────────────────────────────
  sha256: {
  ...
  balloon: {
    ...
    sources: [
      ...
      { label: "NIST SP 800-63B", url: "https://pages.nist.gov/800-63-3/sp800-63b.html", note: "Digital identity guidelines referencing password hashing.", kind: "standard", supports: ["specification", "standardization"] },
    ],
  },
  // ─── MAC ─────────────────────────────────────────────────────────
  hmac_sha256: {
