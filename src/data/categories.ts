...
export const CATEGORY_INFO: CategoryInfoMap = {
  ...
  he:{
    ...
    projects:[
      { name:"Blind Oracle", tech:"TFHE-rs FHE demo — browser encrypts two numbers, Rust server adds them homomorphically, returns encrypted result. The server mathematically cannot see the data it computed.", url:"https://github.com/systemslibrarian/blind-oracle", public:true, app:"systemslibrarian.github.io/blind-oracle" },
      { name:"Blind Oracle API", tech:"Rust + Axum + TFHE-rs backend — gate-bootstrapped homomorphic addition on FheUint8 ciphertexts. Holds only a ServerKey, cannot decrypt its own output.", url:"https://github.com/systemslibrarian/blind-oracle-api", public:true },
    ],
  ...
  ot_pir:{
    ...
    projects:[
      { name:"Patron Shield", tech:"Two-server Information-Theoretic PIR for library catalog privacy", url:"https://github.com/systemslibrarian/patron-shield", public:true },
    ],
