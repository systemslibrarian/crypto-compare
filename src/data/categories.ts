...
export const CATEGORY_INFO: CategoryInfoMap = {
  ...
  symmetric:{
    ...
    projects:[
      ...
      { name:"World Ciphers", tech:"International block ciphers — Camellia, ARIA, SM4, and Kuznyechik side-by-side comparison with live encryption, decryption, and performance benchmarks", url:"https://github.com/systemslibrarian/crypto-lab-world-ciphers", public:true },
      { name:"Protocol Compose", tech:"MAC-then-Encrypt vs Encrypt-then-MAC, padding oracle attack, CRIME, and the composition failures that drove TLS 1.3", url:"https://github.com/systemslibrarian/crypto-lab-protocol-compose", public:true },
    ],
  ...
  kem:{
    ...
    projects:[
      ...
      { name:"Frodo Vault", tech:"FrodoKEM post-quantum KEM — LWE lattice key encapsulation with conservative post-quantum security and no ring structure assumption", url:"https://github.com/systemslibrarian/crypto-lab-frodo-vault", public:true },
    ],
  ...
  signature:{
    ...
    projects:[
      ...
      { name:"Blind Sign", tech:"Chaum RSA blind signatures and Schnorr EC blind signatures — anonymous e-cash, private voting, and unlinkability proofs", url:"https://github.com/systemslibrarian/crypto-lab-blind-sign", public:true },
      { name:"Ring Sign", tech:"LSAG ring signatures — key image linkability, double-spend detection, group signatures with manager opening, and Monero transaction privacy", url:"https://github.com/systemslibrarian/crypto-lab-ring-sign", public:true },
    ],
  ...
  hash:{
    ...
    projects:[
      ...
      { name:"World Hashes", tech:"International hash functions — SM3, Streebog, Kupyna, SHA-256, and SHA-3 comparative analysis with live hashing, avalanche visualization, and performance benchmarks", url:"https://github.com/systemslibrarian/crypto-lab-world-hashes", public:true },
    ],
  ...
  password:{
    ...
    projects:[
      ...
      { name:"Bcrypt Forge", tech:"Bcrypt anatomy, cost factor benchmarking, timing-safe verification, and a real-world breach simulation", url:"https://github.com/systemslibrarian/crypto-lab-bcrypt-forge", public:true },
    ],
  ...
  zkp:{
    ...
    projects:[
      ...
      { name:"STARK Tower", tech:"zk-STARK proofs — AIR constraint generation, FRI commitment protocol, transparent setup, and post-quantum secure zero-knowledge proofs", url:"https://github.com/systemslibrarian/crypto-lab-stark-tower", public:true },
      { name:"SNARK Arena", tech:"Groth16 and PLONK zk-SNARK comparison — trusted setup ceremony, proof generation, verification, and side-by-side performance analysis", url:"https://github.com/systemslibrarian/crypto-lab-snark-arena", public:true },
      { name:"Commit Gate", tech:"Hash commitments and Pedersen commitments — binding, hiding, sealed-bid auction, and homomorphic addition. The primitive beneath ZKPs, MPC, and VSS.", url:"https://github.com/systemslibrarian/crypto-lab-commit-gate", public:true },
    ],
  ...
  mpc:{
    ...
    projects:[
      ...
      { name:"Garbled Gate", tech:"Yao's Garbled Circuits — oblivious transfer, Free XOR optimization, and two-party secure computation with live circuit garbling and evaluation", url:"https://github.com/systemslibrarian/crypto-lab-garbled-gate", public:true },
    ],
  ...
  asymmetric:{
    ...
    projects:[
      ...
      { name:"PKI Chain", tech:"X.509 certificate chains, trust store validation, CA compromise cascades, Certificate Transparency with Merkle inclusion proofs, and post-quantum migration to ML-DSA", url:"https://github.com/systemslibrarian/crypto-lab-pki-chain", public:true },
    ],
  ...
  steganography:{
    ...
    projects:[
      ...
      { name:"Stego Suite", tech:"Steganography suite — LSB, DCT, and adaptive embedding with chi-squared steganalysis detection and statistical analysis", url:"https://github.com/systemslibrarian/crypto-lab-stego-suite", public:true },
    ],
  ...
  threshold_sig:{
    ...
    projects:[
      ...
      { name:"GG20 Wallet", tech:"GG20 threshold ECDSA wallet — Paillier encryption, secp256k1, and distributed key generation for multi-party cryptocurrency signing", url:"https://github.com/systemslibrarian/crypto-lab-gg20-wallet", public:true },
      { name:"Threshold Decrypt", tech:"ElGamal over P-256 — distributed key generation, verifiable partial decryptions with NIZK proofs, and t-of-n threshold decryption", url:"https://github.com/systemslibrarian/crypto-lab-threshold-decrypt", public:true },
    ],
  ...
  csprng:{
    ...
    projects:[
      ...
      { name:"DRBG Arena", tech:"NIST SP 800-90A DRBG comparison — HMAC_DRBG, CTR_DRBG, and Hash_DRBG with live entropy seeding, output visualization, and compliance analysis", url:"https://github.com/systemslibrarian/crypto-lab-drbg-arena", public:true },
    ],
